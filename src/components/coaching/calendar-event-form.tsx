  ...
  return (
    <form action={formAction} className="space-y-4" ref={formRef}>
      ...
      <label className="block">
        ...
        <textarea
          className="mt-2 min-h-28 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm leading-6 outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10"
          name="description"
