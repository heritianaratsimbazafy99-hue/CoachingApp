    ...
    <Card className="overflow-hidden">
      <form action={formAction} className="grid gap-0 lg:grid-cols-[1fr_340px]">
        <div className="space-y-5 p-5 sm:p-6">
          <FormSection
            className="bg-white"
            description="Titre, contexte et message visible côté coaché."
            icon={ClipboardList}
            title="Brief d'assignation"
          >
          ...
          <FormSection
            className="bg-white"
            description="Sélectionnez un contenu, un quiz, ou les deux."
            icon={CalendarClock}
        ...
        <aside className="space-y-5 border-t border-slate-100 bg-slate-50/80 p-5 ring-1 ring-white sm:p-6 lg:border-l lg:border-t-0">
          <FormSection
            description="Choisissez la cible, la deadline et le niveau de priorité."
            icon={Target}
            title="Ciblage"
          >
            <label className="block">
